  ...
  return (
    <div id="container" className="grid grid-cols-1 justify-center m-5">
      <div className="flex flex-col bg-white drop-shadow-md rounded">
        <div id="content" className="flex flex-col gap-12 sm:gap-16 px-4 py-12 md:px-4 md:py-16 xl:px-24 xl:py-24">
          ...
          <div
            ...
            <section id="section-right" className="grid grid-cols-1 w-full lg:w-fit xl:w-[592px] max-h-fit">
                      ...
                      <div id="message-field" className="flex flex-col">
                        <span className="flex flex-col w-full gap-2">
                          ...
                          <div id="msg-bottom" className="flex flex-row w-full">
                            ...
                            <span className="text-sm font-normal text-neutral-500 w-full text-end">0/500</span>
                          </div>
                        </span>
                      </div>
                    </div>
