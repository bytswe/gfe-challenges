...
function FeaturesSideImage({ imgPosition }: { imgPosition: "left" | "right" }) {
  return (
    <>
      {imgPosition === "left" ? (
        <div className="flex flex-col justify-center items-center bg-white drop-shadow-md p-4 md:p-6 xl:p-24 rounded py-12 md:py-16 gap-y-12 md:gap-y-16">
          <section
            id="section-top"
            className="flex flex-col flex-wrap w-fit flex-1 gap-y-5 justify-center items-center">
            <h4 className="text-base font-semibold text-indigo-700">Best-in-class support</h4>
            <h2 className="flex flex-wrap text-center text-3xl md:text-5xl font-semibold text-neutral-900">
          ...
          <section id="section-bottom" className="flex flex-col xl:flex-row gap-x-8">
            <section id="section-left" className="flex w-full flex-grow-0">
              <img
                src="unsplash_rAtzDB6hWrU_1.jpg"
                className="mt-10 mb-12 md:mt-16 md:mb-28 xl:mt-0 xl:mb-0 w-full justify-center object-cover rounded-lg shadow-lg max-h-[180px] sm:max-h-[394px] overflow-hidden"
                alt="Banner image or hero section"
              />
            </section>
            <section id="section-right" className="flex flex-col justify-center gap-y-6 md:gap-y-12 xl:gap-y-20">
              <ul className="flex flex-col text-md md:text-lg lg:text-xl font-normal gap-y-12">
                <li className="flex flex-col items-start">
                  <h6 className="flex flex-row text-base font-semibold justify-center items-center gap-x-3 text-neutral-900">
                  ...
                  <p className="font-normal text-base pl-14 text-neutral-600">
                    Our robust servers are primed to deliver the highest resolution images swiftly, ensuring a smooth
                    download experience.
                  </p>
                </li>
                <li className="flex flex-col items-start">
                  ...
                  <p className="font-normal text-base pl-14 text-neutral-600">
                    Your single account can accommodate multiple users simultaneously downloading without any
                    disruptions, streamlining teamwork and productivity.
                  </p>
                </li>
                <li className="flex flex-col items-start">
                  <h6 className="flex flex-row text-base font-semibold justify-center items-center gap-x-3 text-neutral-900">
                  ...
                  <p className="font-normal text-base pl-14 text-neutral-600">
                    Our straightforward, royalty-free licensing means your chosen images are yours to innovate with,
                    without the hassle of negotiating usage rights for every new project.
                  </p>
                </li>
              </ul>
            </section>
      ...
      {imgPosition === "right" ? (
        <div className="flex flex-col bg-white drop-shadow-md p-4 md:p-6 xl:p-24 rounded py-12 md:py-16 gap-y-12 md:gap-y-16">
          <section id="section-top" className="flex flex-col w-full flex-1 gap-y-5 justify-start items-center">
            <h4 className="text-base font-semibold text-indigo-700">High quality images</h4>
            <h2 className="text-3xl md:text-5xl font-semibold text-neutral-900">For designers, by designers</h2>
          ...
          <section id="section-bottom" className="flex flex-col xl:flex-row gap-x-8">
            <section id="section-left" className="grid grid-col-1 justify-center gap-y-6 md:gap-y-12 xl:gap-y-20">
              <ul className="flex flex-col text-md md:text-lg lg:text-xl font-normal gap-y-12">
                <li className="flex flex-col items-start">
                  <h6 className="flex flex-row text-base font-semibold justify-center items-center gap-x-3 text-neutral-900">
                    <span className="bg-white text-indigo-500 rounded-full p-2.5 h-fit drop-shadow">
                ...
                <li className="flex flex-col items-start">
                  ...
                  <p className="font-normal text-base pl-14 text-neutral-600">
                    We offer a wide array of abstractions, ranging from water to glass, and encompassing various styles
            ...
            <section id="section-right" className="flex w-full">
              <img
...
export default FeaturesSideImage
