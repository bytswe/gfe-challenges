...
function FeatuersGrid() {
  return (
    <div className="flex flex-col hero-bg drop-shadow-md bg-white p-4 md:p-6 xl:p-24 rounded py-12 md:py-16 gap-y-12 md:gap-y-16">
      <section id="section-top" className="flex flex-col w-full flex-1 gap-y-5 justify-center items-center text-center">
        <h4 className="text-base font-semibold text-indigo-700">Premium abstract images</h4>
        <h2 className="text-3xl md:text-5xl font-semibold text-neutral-900">Easy access to top quality images</h2>
        <p className="flex flex-wrap font-normal text-lg">
          In a world where storytelling constantly evolves, we lead with groundbreaking images designed for your
          presentation excellence.
        </p>
      </section>
      <section id="section-bottom" className="grid grid-cols-1 gap-12">
        <section
          id="section-line-1"
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center gap-y-6 md:gap-y-12 xl:gap-y-20">
          <div className="flex flex-col justify-center items-center">
            <span className="bg-white text-indigo-700 rounded-full p-2.5 drop-shadow" id="icon">
          ...
          <div className="flex flex-col justify-start items-center">
            ...
            <h4 className="font-semibold text-xl text-neutral-900 text-center mt-5 mb-2">Purely Handcrafted</h4>
            <p className="font-normal text-base text-center text-neutral-600">
              No AI, no generic images. Crafted from various chemicals, fabrics, clouds, or even particles as small as
              dust.
            </p>
          </div>
          <div className="flex flex-col gap-5 justify-center items-center">
            ...
            <h4 className="font-semibold text-xl text-neutral-900 text-center">All Are Under licensed</h4>
            <p className="font-normal text-base text-center text-neutral-600">
              The only limitation with these abstract images is that you are not able to sell them in any form, whether
              digital or hard copy (such as paintings or prints on paper).
            </p>
          </div>
          <div className="flex flex-col justify-center items-center">
            <span className="bg-white text-indigo-700 rounded-full p-2.5 drop-shadow" id="icon">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h4 className="font-semibold text-xl text-neutral-900 text-center mt-5 mb-2">Empowering For Team</h4>
            <p className="font-normal text-base text-center text-neutral-600">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h4 className="font-semibold text-xl text-neutral-900 text-center mt-5 mb-2">No Limitations</h4>
            <p className="font-normal text-base text-center text-neutral-600">
        ...
        <section
          id="section-line-2"
          className="grid grid-cols-3 gap-8 justify-center gap-y-6 md:gap-y-12 xl:gap-y-20"></section>
      </section>
    </div>
  )
}
